...
BOT_TOKEN    = os.getenv("BOT_TOKEN", "7671631463:AAGZaqjgymY9aUeFMMOYebYCzA")
MONGO_DB     = os.getenv("MONGO_DB", "mongodb+srv://wuplayer:wuplayer@wuplayer.b2wkic8.mongodb.net/?appName=wuplayer")
